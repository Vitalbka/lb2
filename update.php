				...
				// if everything is ok, try to upload file
				    ...
				    if(count($err) == 0)
				    {
				       ...
				       $first_name = $_POST['first_name'];
						...
						mysqli_query($link," UPDATE `users` SET `first_name` = '$first_name', `photo` = '$photo', `last_name` = '$last_name', `password` = '$password', `role_id` = '$role_id' WHERE users.id = $id");
...
// if everything is ok, try to upload file
	...
	$name = $_SESSION['Name'];	
	$photo =  basename( $_FILES["fileToUpload"]["name"]);
mysqli_query($link," UPDATE `users` SET `first_name` = '$first_name', `photo`= '$photo', `last_name` = '$last_name', `password` = '$password' WHERE `users`.`first_name` = '$name'");
